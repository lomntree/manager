	...
	<div data-options="region:'west',title:'MAIN NAVIGATION',border:false"
		...
		<div class="easyui-accordion"
			...
			<div title="商品管理" data-options="iconCls:'fa fa-table'">
				<ul>
					<li id="item-list"
						data-url='${pageContext.request.contextPath}/item-list'>商品列表</li>
					<li id="item-add"
						data-url='${pageContext.request.contextPath}/item-add'>添加商品</li>
					<li id="item-param-list"
						data-url='${pageContext.request.contextPath}/item-param-list'>规格参数</li>
				</ul>
			</div>
			<div title="网站内容管理" data-options="iconCls:'fa fa-table'">
				<ul>
					<li id="content-category"
						data-url='${pageContext.request.contextPath}/content-category'>内容分类管理</li>
					<li id="content"
						data-url='${pageContext.request.contextPath}/content'>内容管理</li>
				</ul>
			</div>
